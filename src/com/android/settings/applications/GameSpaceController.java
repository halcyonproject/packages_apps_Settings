...
public class GameSpaceController extends BasePreferenceController {
    ...
    private static final String GAME_PACKAGE = "com.halcyon.gamespace";
    private static final String GAME_SETTINGS = "com.halcyon.gamespace.settings.SettingsActivity";
